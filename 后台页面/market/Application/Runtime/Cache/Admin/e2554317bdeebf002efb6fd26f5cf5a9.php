...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="/market/index.php/Admin/Goods/lists/id/{sid_user}" target="dialog"><span>详情</span></a></li>			
		</ul>
	</div>
	<table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="126" >
		...
		<tbody>
			...
			<?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($d["id"]); ?>">
					...
					<td ><img src="/market/Public/<?php echo ($d["image0"]); ?>" style="height: 50px;width: 50px;"/><img src="/market/Public/<?php echo ($d["image1"]); ?>" style="height: 50px;width: 50px;"/><img src="/market/Public/<?php echo ($d["image2"]); ?>" style="height: 50px;width: 50px;"/><img src="/market/Public/<?php echo ($d["image3"]); ?>" style="height: 50px;width: 50px;"/><img src="/market/Public/<?php echo ($d["image4"]); ?>" style="height: 50px;width: 50px;"/><img src="/market/Public/<?php echo ($d["image5"]); ?>" style="height: 50px;width: 50px;"/></td>
