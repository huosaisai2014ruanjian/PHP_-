<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/market/index.php/Admin/Chat/index">
...
<div class="pageContent j-resizeGrid">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class=""><a class="icon" href="/market/index.php/Admin/Chat/content?id={sid_user}" target="dialog" ><span>聊天内容</span></a></li>
		</ul>
	</div>
