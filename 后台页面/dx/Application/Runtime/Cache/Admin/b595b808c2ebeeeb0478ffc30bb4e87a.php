...
var UEDITOR_HOME_URL='/Public/Ueditor/',ueditor_loader={};  
//编辑器同步  
...
<link rel="stylesheet" type="text/css" href="/Public/Ueditor/themes/default/css/ueditor.min.css"/>   
...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<a class="logo" href="/index.php" style="color:white;font-size:30px;margin-top:8px;margin-left:13px;">校园跳蚤市场</a>
				<ul class="nav">
					<li><a href="/index.php/Public/password/" target="dialog" mask="true">修改密码</a></li>
					<li><a href="/index.php/Public/profile/" target="dialog" mask="true">修改资料</a></li>
					<li><a href="/Home/user/logout_do">退出</a></li>
				</ul>
	...
	<div id="footer">Copyright &copy; 2016 大学生跳蚤市场有限公司 <a href="#" target="_blank">xuanzhizhongguo.com</a></div>
