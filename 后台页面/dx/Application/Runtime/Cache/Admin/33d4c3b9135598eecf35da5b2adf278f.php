<?php if (!defined('THINK_PATH')) exit();?><form action="/dx/index.php/Admin/Category/doAdd2" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" novalidate="novalidate">
