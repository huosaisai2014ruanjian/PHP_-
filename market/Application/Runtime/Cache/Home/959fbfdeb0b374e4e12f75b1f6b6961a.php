...
<div  class="weui_tab" style="maigin:10px">
    ...
    <div class="xinxi">
        ...
        <p style="font-size: 12px; margin-top: -8px; margin-left: 30px;">电话:15231531523</p>
        <a href=""><p style="font-size: 12px; margin-top: -8px; margin-left: 30px;">收货地址：河北师范大学新校区软件学院</p></a>
    </br>
