    ...
    <div class="weui_tab_bd ">
        <div >
               <!--商品封面图片-->
                ...
                <!--商品封面图片结束-->
                <!--商品价格等信息  -->
                <input type="hidden" name="goodid" id="goodid" value="<?php echo ($good["id"]); ?>"><!-- <?php echo ($good["id"]); ?> -->
            ...
            <?php if( $xihuan == 0): ?><a href="javascript:;" id='hide' class="weui_navbar_item weui_bar_item_on button orange medium" style="display:block;font-size:16px;font-family:'宋体';color:#fff;margin-top:5px;margin-bottom:8px;padding-top:8px">我喜欢<p style="font-size:40px;margin-top:-15px;margin-left:90px;">♡</p></a>
                <a href="javascript:;" id='hide1' class="weui_navbar_item weui_bar_item_on♡ button orange medium" style="display:none; font-size:16px;font-family:'宋体';color:#fff;margin-top:5px;margin-bottom:8px;padding-top:8px">我喜欢<p style="font-size:40px;margin-top:-15px;margin-left:90px;">♥</p></a>
            <?php else: ?>
                <a href="javascript:;" id='hide' class="weui_navbar_item weui_bar_item_on button orange medium" style="display:none;font-size:16px;font-family:'宋体';color:#fff;margin-top:5px;margin-bottom:8px;padding-top:8px">我喜欢<p style="font-size:40px;margin-top:-15px;margin-left:90px;">♡</p></a>
                <a href="javascript:;" id='hide1' class="weui_navbar_item weui_bar_item_on♡ button orange medium" style="display:block; font-size:16px;font-family:'宋体';color:#fff;margin-top:5px;margin-bottom:8px;padding-top:8px">我喜欢<p style="font-size:40px;margin-top:-15px;margin-left:90px;">♥</p></a><?php endif; ?>         
