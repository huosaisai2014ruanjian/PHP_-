...
<div class="weui-row weui-no-gutter" >
    <?php if(is_array($goods1)): $i = 0; $__LIST__ = $goods1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="weui-col-50" align="center"><a href="/php_-/market/index.php/Home/Gooddetail/index?id=<?php echo ($vo['id']); ?>">
...
<!--商品列表结束-->
      ...
      <div>
          ...
          <!--内容栏开始-->
          <div class="weui-row weui-no-gutter" >
              <?php if(is_array($goods2)): $i = 0; $__LIST__ = $goods2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="weui-col-50" align="center"><a href="/php_-/market/index.php/Home/Gooddetail/index?id=<?php echo ($vo['id']); ?>">
                      <img src="/php_-/market/Public/<?php echo ($vo["photo"]); ?>" ></a>
                      <p class="goodname" style="text-align:center;font-size:6px;"><?php echo ($vo["name"]); ?>
                      <p class="price" style="text-align:center;color: #FF0000;">&yen;<?php echo ($vo["price"]); ?></p>
                      </p>
