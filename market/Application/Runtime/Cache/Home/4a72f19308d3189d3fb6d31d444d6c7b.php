                ...
                <div class="weui_panel weui_panel_access">
                    ...
                    <div class="weui_panel_bd">
                        <?php if(is_array($transaction)): $i = 0; $__LIST__ = $transaction;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$transaction): $mod = ($i % 2 );++$i;?><div>
                                <a href="/market/index.php/Home/Gooddetail/index?id=<?php echo ($transaction["id"]); ?>" class="weui_media_box weui_media_appmsg">
                                    <div class="weui_media_hd">
                                        <img class="weui_media_appmsg_thumb" src="/market/Public/<?php echo ($transaction["photo"]); ?>">
                                    </div>
                                ...
                                <div class="anniu"><a href="/market/index.php/Home/Personal/delete/id/<?php echo ($transaction["id"]); ?>" class="button orange medium sc">删除订单记录</a> </div>
                                <br/>
