...
<head>
    ...
    <body>
        <form action="/market/index.php/Home/Personal/CertificateAuthority" method="post" id="register_from" enctype="multipart/form-data">
            ...
            <div style="background-color:#F7F7F7">
                <div class="weui_cells weui_cells_form">
                    ...
                    <div class="weui_cell">
                        ...
                        <div class="weui_cell_bd weui_cell_primary">
                            <input class="weui_input tel phone_register phone_loginByPhone" id="cellphone" type="name" name="phonenumber" placeholder="请输入手机号">
                        </div>
                    </div>
                    <!--输入验证码-->
                    <div class="weui_cell">
                        ...
                        <div class="weui_cell_bd weui_cell_primary">
                            <input style="width:70px;" class="check weui_input" name="vcode" id="vcodeForRegister" type="name" placeholder="验证码">
                            <input style="border:0px;background-color:white;float:right;margin-top:5px;" type="button" value="获取验证码" class="addcheck" onclick="sendMessage('.phone_register')" id="btnSendCodeForRegister" />
                        </div>
                    </div>
                    <!--上传照片-->
                    <div>
                        ...
                        <p style="font-size:85%">&nbsp;&nbsp;&nbsp;(要求：图片要清晰，支持jpg,png格式，大小不超过2M)
                            <div class="weui_cell">
                                <div class="weui_cell_bd weui_cell_primary">
                                    <div class="weui_uploader">
                                        ...
                                        <div class="weui_uploader_bd" style="">
                                            <ul class="weui_uploader_files">
                                                <!-- 预览图插入到这 -->
                                            </ul>
                                            <div class="weui_uploader_input_wrp" style="left:40%;">
                            ...
                            <div style="text-align:center">
                                ...
                                <input style="width:100%;height:30px;" class="button orange" onclick="return checkForRegister();" type="submit" value="提交">
                            </div>
                    </div>
        </form>
    </body>
    ...
    function sendMessage(ele) {
        ...
        $("#btnSendCodeForRegister").val(curCount + "秒后重新获取");
        InterValObj = window.setInterval(SetRemainTime, 1000); //启动计时器，1秒执行一次
        // 向后台发送处理数据
        $.ajax({
            type: "POST", //用POST方式传输
            url: '/market/index.php/Home/Personal/SendSMS/cellphone/' + document.getElementById("cellphone").value, //目标地址
            data: {
                'tel': phone
            },
    ...
    function checkForRegister() {
        ...
        if ($('#hidden').val() == $('#vcodeForRegister').val()) {
            ...
            // window.location.href="/market/index.php/Home/Personal/rzsuccess";  
        } else {
