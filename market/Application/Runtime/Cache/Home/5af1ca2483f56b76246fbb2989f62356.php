...
<div class="mybody">
    ...
    <div class="left">
        ...
        <div class="leftnav">
            ...
            <ul>
                <?php if(is_array($gongluetype1)): $i = 0; $__LIST__ = $gongluetype1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="#"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        ...
        <div class="leftnav">
            ...
            <ul>
                <?php if(is_array($gongluetype2)): $i = 0; $__LIST__ = $gongluetype2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="#"><?php echo ($vo["title"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
    ...
    <div class="right">
        ...
        <ul class="rightul">
          <?php if(is_array($infodetail)): $i = 0; $__LIST__ = $infodetail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
            	<div class="litop">
                	<h1><a href="./strategydetails/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?></a></h1>
                </div>
                <p><a href="./strategydetails/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["summary"]); ?></a></p>
                <div class="det">
                <div class="time">
                ...
                <div class="time time2">
                        ...
                        <span class="sj">浏览<span class="scan">111</span></span>
                </div>
                </div>
