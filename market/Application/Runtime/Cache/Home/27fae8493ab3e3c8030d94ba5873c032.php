...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/market/Public/css/button.css">
    <style type="text/css">
    html,
    body {
        height: 100%;
                        ...
                        <div class="content">
                            ...
                            <div class="weui_panel weui_panel_access">
                                <div class="weui_panel_bd">
                                    <?php if(is_array($manage)): $i = 0; $__LIST__ = $manage;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$manage): $mod = ($i % 2 );++$i;?><input value="<?php echo ($manage["goods_id"]); ?>" name="goods_id" type="hidden">
                                        <div>
                                            <a href="/market/index.php/Home/gooddetail/index/id/<?php echo ($manage["id"]); ?>" class="weui_media_box weui_media_appmsg">
                                                <div class="weui_media_hd">
                                                    <img class="weui_media_appmsg_thumb" src="/market/Public/<?php echo ($manage["photo"]); ?>">
                                                </div>
                                            ...
                                            <div class="anniu">
                                                <a href="/market/index.php/Home/Agoods/Agoods/id/<?php echo ($manage["id"]); ?>" class="button orange medium">修改商品</a>
                                                <a href="/market/index.php/Home/Personal/saled/id/<?php echo ($manage["id"]); ?>" class="button orange medium saled">已卖出</a>
                                                <a href="/market/index.php/Home/Personal/down/id/<?php echo ($manage["id"]); ?>" class="button orange medium">不想卖了</a>
                                            </div>
                            ...
                            <div class="weui_panel weui_panel_access">
                                <div class="weui_panel_bd">
                                    <?php if(is_array($down)): $i = 0; $__LIST__ = $down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$down): $mod = ($i % 2 );++$i;?><div>
                                            <a href="/market/index.php/Home/gooddetail/index/id/<?php echo ($down["id"]); ?>" class="weui_media_box weui_media_appmsg">
                                                <div class="weui_media_hd">
                                                    <img class="weui_media_appmsg_thumb" src="/market/Public/<?php echo ($down["photo"]); ?>">
                                                </div>
                                                <div class="weui_media_bd">
                                            ...
                                            <div class="anniu">
                                                <a href="/market/index.php/Home/Personal/up/id/<?php echo ($down["id"]); ?>" class="button orange medium" id="dingdan">重新上架</a>
                                                <a href="/market/index.php/Home/Personal/deletesp/id/<?php echo ($down["id"]); ?>" class="button orange medium">彻底删除</a>
                                            </div>
                                        </div><?php endforeach; endif; else: echo "" ;endif; ?>
                                </div>
                            </div>
