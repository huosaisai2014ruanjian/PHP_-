    ...
    <body>
        <div class="weui_tab">
          ...
          失效宝贝
                ...
                <br/>
                <!--第一个主题开始部分-->
                <form method="post" action="/market/index.php/Home/Personal/deletesc">
                    ...
                    <div class="weui_pan  el weui_panel_access">
                        <div class="weui_panel_bd">
                            <?php if(is_array($up)): $i = 0; $__LIST__ = $up;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$up): $mod = ($i % 2 );++$i;?><a href="/market/index.php/Home/Gooddetail/index?id=<?php echo ($up["goods_id"]); ?>" style="margin-top: 1px;" class="weui_media_box weui_media_appmsg">
                                    <input type="checkbox" name="sp[]" class="sp1" value="<?php echo ($up["id"]); ?>">
                                    <div class="weui_media_hd">
                                        <img class="weui_media_appmsg_thumb" src="/market/Public/<?php echo ($up["photo"]); ?>">
                                    </div>
                ...
                <form method="post" action="/market/index.php/Home/Personal/deletesc">
                    ...
                    <div class="weui_pan  el weui_panel_access">
                        <div class="weui_panel_bd">
                            <?php if(is_array($down)): $i = 0; $__LIST__ = $down;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$down): $mod = ($i % 2 );++$i;?><a href="/market/index.php/Home/Gooddetail/index?id=<?php echo ($down["goods_id"]); ?>" class="weui_media_box weui_media_appmsg">
