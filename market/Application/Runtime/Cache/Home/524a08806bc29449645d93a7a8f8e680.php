...
<link href="/Public/js/jquery-1.7.2.min.js" rel="stylesheet" type="text/css" />
		...
		<!--用户注册-->
        	<div class="search search1">
                    <form action="/index.php/Home/Login/zhuce1" method="post">
                        ...
                        <input type="text" placeholder="手机号码" class="tel" name="tel" id="cellphone"/>
...
huoqu.onclick=function(){
	...
	$.ajax({
        type: 'GET',
        url: '/index.php/Home/Login/SendSMS/cellphone/'+document.getElementById("cellphone").value,
        dataType: 'text',
