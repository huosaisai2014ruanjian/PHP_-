...
<form id="pagerForm" method="post" action="/market/index.php/Home/Menu/view">
...
<div class="pageContent j-resizeGrid">
    <div class="panelBar">
        <ul class="toolBar">
            <li class=""><a class="add" href="<?php echo U('home/menu/manage');?>" target="navTab"><span>创建菜单</span></a></li>
        </ul>
    </div>
