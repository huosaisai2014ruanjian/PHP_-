<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/index.php/Admin/Fytag" method="post">
...
function test(tab){
      $.ajax({
        type: 'GET',
        url: '/index.php/Admin/Fytag/gettab/id/'+tab,
        dataType: 'text',
	 ...
	 function deleteparentnode(id){
		testConfirmMsg('/index.php/Admin/Fytag/deleteparentNode/id/'+id,id);
    }
	
	function deletenode(id){
		testConfirmMsg('/index.php/Admin/Fytag/deleteNode/id/'+id,id);
    }
...
<div class="pageContent">
  <div class="panelBar">
    <ul class="toolBar">
      <li><a class="add" href="/index.php/Admin/Fytag/addyiji" rel="areapage1" target="dialog" fresh="false"><span>添加一级关联标签</span></a></li>
      <li><a class="add" href="/index.php/Admin/Fytag/adderji" rel="areapage2" target="dialog" fresh="false"><span>添加二级关联标签</span></a></li>
    </ul>
  </div>
  </div>
  ...
  <div class="warp">
      <div class="right">
       <div class="tree" >
        <ul id="tab1">
          <?php if(is_array($tab1)): $i = 0; $__LIST__ = $tab1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tab): $mod = ($i % 2 );++$i;?><li class="provinceli"><div onclick="test(<?php echo ($tab["id"]); ?>);"><img src="/Public/Area/images/tree_folder4.gif" valign="abvmiddle" class="tag"  name="change"/><?php echo ($tab["name"]); ?><a href="/index.php/Admin/Fytag/adderji/pid/<?php echo ($tab["id"]); ?>"  target="dialog"  title='添加二级标签' class="addpic"> + </a>  <a  href="javascript:;" onclick='deleteparentnode(<?php echo ($tab["id"]); ?>);' class="deletepic"> - </a> </div>
