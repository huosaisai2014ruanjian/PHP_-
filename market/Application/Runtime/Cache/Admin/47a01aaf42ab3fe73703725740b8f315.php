<?php if (!defined('THINK_PATH')) exit();?>
   <form action="/index.php/Admin/Fytag/doAdd2" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" novalidate="novalidate">
