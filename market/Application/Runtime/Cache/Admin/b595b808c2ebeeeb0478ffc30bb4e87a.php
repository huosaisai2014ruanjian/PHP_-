...
<![endif]-->
    ...
    var UEDITOR_HOME_URL = '/market/Public/Ueditor/',
        ueditor_loader = {};
    //编辑器同步  
    ...
    $(function() {
        DWZ.init("/market/Public/dwz/dwz.frag.xml", {
            loginUrl: "/market/index.php/Public/login_dialog",
            ...
            callback: function() {
                initEnv();
                $("#themeList").theme({
                    themeBase: "/market/Public/dwz/themes"
                });
            }
        });
    });
...
<body scroll="no">
    <div id="layout">
        <div id="header">
            <div class="headerNav">
                <a class="logo" href="/market/index.php" style="color:white;font-size:30px;margin-top:8px;margin-left:13px;">校园跳蚤市场</a>
                <ul class="nav">
                    ...
                    <li><a href="/market/index.php/home/login/logout">退出</a></li>
                </ul>
