...
<!-- <div class="pageContent"> -->
    ...
    <div class="pageFormContent nowrap" layouth="97">
        ...
        <dl>
            ...
            <script id="uecontainer" name="uecontainer" type="text/plain"><?php echo (htmlspecialchars_decode($t["content"])); ?></script>
            </dd>
        </dl>
		...
		<dl>
            ...
            <dd>
				<select class="chzn-select" data-placeholder="请填写标签" style="width:350px;" tabindex="1" multiple="multiple" > 
					<option value=""></option> 
					<?php if(is_array($taglist)): $i = 0; $__LIST__ = $taglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$s): $mod = ($i % 2 );++$i;?><option value="<?php echo ($s["name"]); ?>"><?php echo ($s["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
				</select> 
            </dd>
        </dl>
    </div>
