...
<!-- <div class="pageContent"> -->
    <form action="/index.php/Admin/GonglueInfo/add" method="post" enctype="multipart/form-data" method="post" class="pageForm required-validate" onsubmit="beforeSubmit();return validateCallback(this, navTabAjaxDone);" novalidate="novalidate" >
    <div class="pageFormContent nowrap" layouth="97">
        ...
        <dl>
		 ...
		 <dl>
            <dt>类型:</dt>
            <dd>
				<select name="gongluetypeid" id="gltypeid" >
				<option value="0">请选择</option>
				  <?php if(is_array($gongluetypelist)): $i = 0; $__LIST__ = $gongluetypelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$onetype): $mod = ($i % 2 );++$i;?><option value="<?php echo ($onetype["id"]); ?>"><?php echo ($onetype["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
			  </select>      
            </dd>
        </dl>
        ...
        <dl>
            <dt>详情:</dt>
            <dd>
            <input type="hidden" name="content" id="content" value="" z-index="1" />
		  ...
		  <dl z-index="1000" >
            <dt>标签:</dt>
            <dd>
             <select class="chzn-select" data-placeholder="请填写标签" style="width:350px;"   multiple="multiple" z-index="1000" > 
				<option value=""></option> 
