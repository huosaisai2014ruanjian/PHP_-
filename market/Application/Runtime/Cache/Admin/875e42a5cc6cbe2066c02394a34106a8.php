<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/index.php/Admin/Information/zxindex/">
						...
						<div class="pageContent" style="height:auto;">
							<div class="panelBar">
								<ul class="toolBar">
									...
									<li class="line">line</li>
									<li><a class="edit" href="/index.php/Admin/Information/show?id={sid_user}" target="dialog"><span>详情</span></a></li>
								</ul>
							</div>
						</div>
