<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" method="post" action="/demo/index.php/Admin/Transaction/index/"></form>

<div class="pageHeader" id="Transaction_indexid" >
<form method="post" >
	<div class="searchBar">
			商品名称：
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="/demo/index.php/Admin/Transaction/add" target="navTab"><span>添加</span></a></li>
			<li><a class="delete" href="/demo/index.php/Admin/Transaction/destroy/id/{sid_user}" target="ajaxTodo" title="确定要删除吗？" warn="请选择一个用户"><span>删除</span></a></li>
			<li><a class="edit" href="/demo/index.php/Admin/Transaction/edit/id/{sid_user}" target="navTab" warn="请选择一个用户"><span>修改</span></a></li>				
		</ul>
	</div>
...
<script>
	...
	var data="/demo/index.php/Admin/Transaction/index";
	sousuo.onclick=function(){
		this.value='';
	}
	submit.onmouseover=function(){	
	data="/demo/index.php/Admin/Transaction/search?condition="+sousuo.value;
	this.href=data;
	}
</script>