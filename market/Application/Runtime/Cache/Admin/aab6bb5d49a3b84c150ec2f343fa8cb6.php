<?php if (!defined('THINK_PATH')) exit();?>
  <script type="text/javascript">
   ...
   <form action="/index.php/Admin/Area/doAdd2" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" novalidate="novalidate">
   ...
   省区：
    ...
    市区：
     ...
     区(县)：<input type="input" name="name" class="required" alt="添加的区"/><span class="info">请输入添加的区</span></br></br>
