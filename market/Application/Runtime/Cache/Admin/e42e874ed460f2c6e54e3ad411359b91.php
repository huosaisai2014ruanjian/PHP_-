<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/demo/index.php/Admin/Chat" method="post">
...
<div class="pageContent j-resizeGrid">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li class=""><a class="delete" href="/demo/index.php/Admin/Chat/destroy?id={sid_user}"target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
			<li class=""><a class="edit" href="/demo/index.php/Admin/Chat/show?id={sid_user}" target="navTab"><span>修改</span></a></li>
			<li class="line">line</li>
			<li class=""><a class="icon" href="/demo/index.php/Admin/Chat/content?id={sid_user}" target="dialog" ><span>聊天内容</span></a></li>
		</ul>
	</div>
		...
		<tbody>
			   <?php if(is_array($results)): $i = 0; $__LIST__ = $results;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr target="sid_user" rel="<?php echo ($vo['id']); ?>">
					...
					<td><?php echo (subtext($vo['content'],10)); ?></td>
