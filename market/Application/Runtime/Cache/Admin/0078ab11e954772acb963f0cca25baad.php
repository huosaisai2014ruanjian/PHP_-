<?php if (!defined('THINK_PATH')) exit();?>
   <form action="/index.php/Admin/Wdfl/doAdd2" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, navTabAjaxDone);" novalidate="novalidate">
   <input type="hidden" name="id" />
    一级标签：
     ...
     二级标签：<input type="input" name="name" class="required" alt="请输入添加的二级标签/><span class="info">请输入添加的二级标签</span></br></br>
