<?php if (!defined('THINK_PATH')) exit();?><form id="pagerForm" action="/demo/index.php/Admin/System" method="post">
...
<div class="pageContent j-resizeGrid">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li class=""><a class="delete" href="/demo/index.php/Admin/System/destroy?id={sid_user}"target="ajaxTodo" title="确定要删除吗?"><span>删除</span></a></li>
            <li class=""><a class="edit" href="/demo/index.php/Admin/System/edit?id={sid_user}" target="navTab"><span>修改</span></a></li>
            <li class="line">line</li>
            <li class=""><a class="icon" href="/demo/index.php/Admin/System/content?id={sid_user}" target="dialog" ><span>系统消息内容</span></a></li>
        </ul>
    </div>
