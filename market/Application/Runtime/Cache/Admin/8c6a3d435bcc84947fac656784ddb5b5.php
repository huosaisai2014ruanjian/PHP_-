<?php if (!defined('THINK_PATH')) exit();?> <link rel="stylesheet" type="text/css" href="/demo/Public/menu/css/common.css"/>
 <link rel="stylesheet" type="text/css" href="/demo/Public/menu/css/main.css"/>
 <form id="pagerForm" method="post" action="/demo/index.php/Admin/Menu/manage">
...
<div class="pageContent j-resizeGrid">
    <div class="panelBar">
        <ul class="toolBar">
            <li class=""><a class="add" href="/demo/index.php/Admin/Menu/view" target="dialog"><span>显示</span></a></li>
        </ul>
    </div>
    ...
    <ul class="sys-info-list">
        <form action="/demo/index.php/Admin/Menu/create" method="post" id="only">
        <?php $ii=1;?>
        <?php if(is_array($menu)): $i = 0; $__LIST__ = $menu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="mainM">
            ...
            <input type="text" name="value" value="<?php echo ($vo->key); echo ($vo->url); ?>"/>&nbsp;<a href="#" class="add">增加</a>&nbsp;<a href="#" class="delete">删除</a>
            ...
            <input type="text" name="value" value="<?php echo ($sub_vo->key); echo ($sub_vo->url); ?>"/>&nbsp;<a href="" class="delete">删除</a>
...
<script type="text/javascript" src="/demo/Public/js/jquery-2.2.3.min.js"></script>
...
var menu = new Array(); //存储菜单对象
    ...
    $.post(url,{'menu':menu},function(data){
        if(data=='ok'){
            alert('菜单创建成功');
            window.location.href="/demo/index.php/Admin/Menu/view";
        }else{
            alert(data);
