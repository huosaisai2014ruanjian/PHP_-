...
<form id="pagerForm" method="post" action="/market/index.php/Admin/Menu/manage">
...
<div class="pageContent j-resizeGrid">
    <div class="panelBar">
        <ul class="toolBar">
            <li class=""><a class="add" href="/market/index.php/Admin/Menu/view" target="dialog"><span>显示</span></a></li>
        </ul>
    </div>
    <div class="result-wrap">
        ...
        <div class="result-content">
            ...
            <ul class="sys-info-list">
                <form action="/market/index.php/Admin/Menu/create" method="post" id="only">
                    <?php $ii=1;?>
...
$("#createMenu").click(function() {
    ...
    $.post(url, {
        ...
        if (data == 'ok') {
            alert('菜单创建成功');
            window.location.href = "/market/index.php/Admin/Menu/view";
        } else {
            alert(data);
