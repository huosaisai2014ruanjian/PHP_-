...
<table class="table" width="100%" layoutH="138">
		...
		<?php if(is_array($toubiao)): $i = 0; $__LIST__ = $toubiao;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr rel="<?php echo ($vo["id"]); ?>" target="sid_user">
				...
				<td>
					...
					<a class="delete" href="/index.php/Admin/Bid/deletetb/id/<?php echo ($vo["id"]); ?>" target="navTab">删除</a>
					<a class="delete" href="/index.php/Admin/Bid/xg/id/<?php echo ($vo["id"]); ?>" target="navTab">修改</a>
				</td>
