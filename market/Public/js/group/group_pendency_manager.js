...
function initGetApplyJoinGroupPendency(data) {
    $('#get_apply_join_group_pendency_table').bootstrapTable({
        ...
        columns: [
            ...
            {field: "Authentication", title: "Authentication", align: "center", valign: "middle", sortable: "true", visible: false},
            {field: "UserDefinedField", title: "UserDefinedField", align: "center", valign: "middle", sortable: "true", visible: false},
            ...
            {field: "gajgpOperate", title: "操作", align: "center", valign: "middle", formatter: "gajgpOperateFormatter", events: "gajgpOperateEvents"}
        ],
        data: data,
